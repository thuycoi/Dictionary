...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference('Translation.count') do
      post translations_url, params: { translation: { explain: @translation.explain, gword_id: @translation.gword_id, like: @translation.like, vword_id: @translation.vword_id } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { explain: @translation.explain, gword_id: @translation.gword_id, like: @translation.like, vword_id: @translation.vword_id } }
